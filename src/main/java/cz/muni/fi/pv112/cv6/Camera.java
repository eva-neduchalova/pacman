 ...
 *
 * This is a VERY SIMPLE class that allows to very simply move with the camera. It is not a perfect, brilliant, smart, or whatever
 * implementation of a camera, but it is sufficient for PV112 lectures.
 *
 * Use left mouse button to change the point of view. Use right mouse button to zoom in and zoom out.
 */
public class Camera {
